from one_second_alternative.Shape import *
from one_second_alternative.Triangle import Equilateral,TriRectangle
from one_second_alternative.Rectangle import Square
